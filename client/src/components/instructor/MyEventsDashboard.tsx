...
import EventGuestListDialog from "./EventGuestListDialog";
import {
  Calendar,
  MapPin,
  Users,
...
export default function MyEventsDashboard({
  ...
  // Guest list dialog — full add/list/resend UI for guest invites
  ...
  return (
    <div className="space-y-6">
              ...
              <CardContent className="p-4 space-y-3">
                ...
                <div className="flex gap-2">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={(e) => { e.stopPropagation(); setGuestListEvent(event); }}
      ...
      {/* Guest list dialog — add / list / resend / remove all in one place */}
      <EventGuestListDialog
        open={!!guestListEvent}
